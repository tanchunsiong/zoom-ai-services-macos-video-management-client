...
display. Its text-size slider scales both the source caption and translation and
remembers the selected size between launches. Closing the panel does not stop the Live
session. Completed segments appear newest-first in the main Live view. The Summarize
button sends a snapshot of the captured source transcript to Zoom Summarizer and opens
the formatted result in a copyable sheet.
